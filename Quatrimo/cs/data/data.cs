...
{ //ADJUST boson origin for better rotation (probably should be 1,1)
    ...
    static blockSet common = new([new baseBasicBlock()], [100]); //this contains all possible tiletypes for the Common tileset; rewrite this eventually to have weights as well
    ...
    {
        bLong = new(4, 1, new blockSet[,] { { common }, { common }, { common }, { common } }, new Vector2I(2, 0), 4, "Line", deflt, Game1.round);
        bSquare = new(2, 2, new blockSet[,] { { common, common }, { common, common } }, new Vector2I(1, 1), 4, "Square", deflt, Game1.round);
        bTBlock = new(3, 2, new blockSet[,] { { common, null }, { common, common }, { common, null } }, new Vector2I(1, 0), 4, "T Block", deflt, Game1.round);
        bLBlockR = new(2, 3, new blockSet[,] { { common, common, common }, { common, null, null } }, new Vector2I(0, 1), 4, "Right L Block", deflt, Game1.round);
        bLBlockL = new(2, 3, new blockSet[,] { { common, null, null }, { common, common, common } }, new Vector2I(0, 1), 4, "Left L Block", deflt, Game1.round);
        bZBlockR = new(2, 3, new blockSet[,] { { null, common, common }, { common, common, null } }, new Vector2I(0, 1), 4, "Right Z Block", deflt, Game1.round);
        bZBlockL = new(2, 3, new blockSet[,] { { common, common, null }, { null, common, common } }, new Vector2I(0, 1), 4, "Left Z Block", deflt, Game1.round);

        bWedge = new(2, 2, new blockSet[,] { { common, common }, { common, null } }, new Vector2I(0, 0), 3, "Wedge", deflt, Game1.box);
        bTwig = new(1, 2, new blockSet[,] { { common, common } }, new Vector2I(0, 1), 2, "Twig", deflt, Game1.round);

        bStick = new(3, 1, new blockSet[,] { { common }, { common }, { common } }, new Vector2I(1, 0), 3, "Stick", deflt, Game1.round);
        bBowl = new(3, 2, new blockSet[,] { { common, common }, { common, null }, { common, common } }, new Vector2I(1, 0), 5, "Bowl", deflt, Game1.circle);
        bCorner = new(3, 3, new blockSet[,] { { common, common, common }, { common, null, null }, { common, null, null } }, new Vector2I(0, 0), 5, "Corner", deflt, Game1.box);
        bRectangle = new(3, 2, new blockSet[,] { { common, common }, { common, common }, { common, common } }, new Vector2I(1, 0), 6, "Rectangle", deflt, Game1.box);
        bCrowbarL = new(2, 5, new blockSet[,] { { common, common, common, common, common }, { null, null, null, null, common } }, new Vector2I(0, 3), 6, "Left Crowbar", deflt, Game1.box);
        bCrowbarR = new(2, 5, new blockSet[,] { { null, null, null, null, common }, { common, common, common, common, common } }, new Vector2I(0, 3), 6, "Right Crowbar", deflt, Game1.box);
        bLongT = new(3, 3, new blockSet[,] { { null, null, common }, { common, common, common }, { null, null, common } }, new Vector2I(1, 1), 5, "Long T Block", deflt, Game1.box_full);

        bCaret = new(2, 3, new blockSet[,] { { common, null, common }, { null, common, null } }, new Vector2I(0, 1), 3, "Caret", deflt, Game1.circle);
        bNub = new(1, 1, new blockSet[,] { { common } }, Vector2I.zero, 1, "Nub", deflt, Game1.circle);
        bDipole = new(3, 2, new blockSet[,] { { common, common }, { null, null }, { common, common } }, new Vector2I(1, 1), 4, "Dipole", deflt, Game1.box_full);
        bSlash = new(2, 2, new blockSet[,] { { common, null }, { null, common } }, Vector2I.zero, 2, "Slash", deflt, Game1.circle);
        bStump = new(4, 2, new blockSet[,] { { common, null }, { common, common }, { common, common }, { common, null } }, new Vector2I(1, 1), 6, "Stump", deflt, Game1.circle);
        bHatchetL = new(4, 2, new blockSet[,] { { common, common }, { common, common }, { null, common }, { null, common } }, new Vector2I(2, 0), 6, "Left Hatchet", deflt, Game1.box);
        bHatchetR = new(4, 2, new blockSet[,] { { null, common }, { null, common }, { common, common }, { common, common } }, new Vector2I(1, 0), 6, "Right Hatchet", deflt, Game1.box);

        bHookL = new(2, 3, new blockSet[,] { { null, null, common }, { common, common, null } }, new Vector2I(1, 1), 3, "Left Hook", deflt, Game1.box);
        bHookR = new(2, 3, new blockSet[,] { { common, common, null }, { null, null, common } }, new Vector2I(0, 1), 3, "Right Hook", deflt, Game1.box);
        bPickL = new(4, 2, new blockSet[,] { { common, null }, { common, common }, { common, null }, { common, null } }, new Vector2I(2, 0), 5, "Left Pick", deflt, Game1.box);
        bPickR = new(4, 2, new blockSet[,] { { common, null }, { common, null }, { common, common }, { common, null } }, new Vector2I(2, 0), 5, "Right Pick", deflt, Game1.box);
        bLepton = new(3, 1, new blockSet[,] { { common }, { null }, { common } }, new Vector2I(1, 0), 2, "Lepton", deflt, Game1.circle);
        bBoson = new(3, 3, new blockSet[,] { { common, common, null }, { common, common, null }, { null, null, common } }, new Vector2I(1, 1), 5, "Boson", deflt, Game1.circle_full);

        bDiamond = new(3, 3, new blockSet[,] { { null, common, null }, { common, common, common }, { null, common, null } }, new Vector2I(1, 1), 5, "Diamond", deflt, Game1.circle);
        bBrick = new(4, 3, new blockSet[,] { { common, common, common }, { common, common, common }, { common, common, common }, { common, common, common } }, new Vector2I(2, 2), 12, "Brick", deflt, Game1.heavy_full);

        bBarycenter = new(5, 2, new blockSet[,] { { common, common }, { common, common }, { null, null }, { common, common }, { common, common } }, new Vector2I(3, 1), 8, "Barycenter", deflt, Game1.heavy);
        bBasin = new(4, 2, new blockSet[,] { { common, common }, { null, common }, { null, common }, { common, common } }, new Vector2I(2, 2), 6, "Basin", deflt, Game1.box);
        bHammer = new(4, 3, new blockSet[,] { { null, common, null }, { null, common, null }, { common, common, common }, { common, common, common } }, new Vector2I(1, 1), 8, "Hammer", deflt, Game1.heavy);
        bBar = new(4, 2, new blockSet[,] { { common, common }, { common, common }, { common, common }, { common, common } }, new Vector2I(2, 1), 8, "Bar", deflt, Game1.block_fuller);
        bLonger = new(5, 1, new blockSet[,] { { common }, { common }, { common }, { common }, { common } }, new Vector2I(3, 0), 5, "Loong", deflt, Game1.box_solid);
        bAngle = new(3, 3, new blockSet[,] { { null, common, common }, { common, common, common }, { common, common, common } }, new Vector2I(2, 2), 8, "Angle", deflt, Game1.heavy_full);
