...
public class boardPieceold
{   //IDEA IDEA IDEA: add method to "undraw" piece from the element board after it is drawn while falling
    public boardPieceold(tile[] tiles, Vector2I dimensions, Vector2I origin, string name, rarity rarity, Color color, Texture2D tex ,board board)
    {
        this.tiles = tiles;
    ...
    { //dimensions.y -origin.y+1
        pos = new Vector2I(5, 8 - (dimensions.y/2)); //change to proper position later
        updateTilePosition();
    }
